...
public:
    ...
    typedef std::function<void(const CommonAPI::CallStatus&, const int32_t&)> AnswerNotifyAsyncCallback;
    ...
    virtual void answerNotify(int32_t _answer, CommonAPI::CallStatus &_internalCallStatus, int32_t &_result, const CommonAPI::CallInfo *_info = nullptr) = 0;
    virtual std::future<CommonAPI::CallStatus> answerNotifyAsync(const int32_t &_answer, AnswerNotifyAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr) = 0;
    ...
    virtual AskNotifyEvent& getAskNotifyEvent() = 0;
